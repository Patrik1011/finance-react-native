...
import { Category, createCategory, deleteCategory, getCategories, updateCategory } from '@/services/categoryService';
    ...
    <View className='px-6 mt-20'>
      ...
      <View className="flex-row items-center gap-x-2 mt-2">
        ...
        <View className='w-1/3'>
          <Button className="p-3 bg-blue-300 rounded-xl" onPress={handleCreateOrUpdateCategory}>
          ...
          <View className='mt-2 py-2 px-4 bg-gray-200 rounded-lg flex-row justify-between items-center'>
            ...
            <View className='flex-row gap-x-2'>
              <TouchableOpacity onPress={() => handleEditCategory(item)}>
                <Text className='text-white bg-green-500 border-green-500 py-2 px-3 rounded-lg'>Edit</Text>
              </TouchableOpacity>
