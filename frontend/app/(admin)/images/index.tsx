...
export default function AdminImagesScreen() {
  ...
  if (isError) {
    return (
      <View className="flex-1 justify-center items-center">
        <Text className="text-error-600 text-base text-center">
  ...
  if (!data || data.length === 0) {
    return (
      <View className="flex-1 justify-center items-center">
        <Text className="text-typography-600 text-base text-center">
          No images found
        </Text>
      </View>
    );
        ...
        renderItem={({ item }) => (
          ...
          >
            <Image
              ...
              resizeMode="cover"
            />
            <Text className="p-2 text-xs text-center text-typography-500">
              Entry #{item.entryId}
            </Text>
          </Pressable>
        )}
