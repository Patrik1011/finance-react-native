...
export class DatabaseNaming1743367629747 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "entry_entity" RENAME COLUMN "categoryId" TO "category_id"`);
        await queryRunner.query(`ALTER TABLE "category_entity" ADD "user_id" integer`);
        await queryRunner.query(`ALTER TABLE "user_entity" ADD "first_name" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user_entity" ADD "last_name" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "entry_entity" ADD CONSTRAINT "FK_b90ec0c559a879717f2f6bba3cf" FOREIGN KEY ("category_id") REFERENCES "category_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "entry_entity" DROP CONSTRAINT "FK_b90ec0c559a879717f2f6bba3cf"`);
        ...
        await queryRunner.query(`ALTER TABLE "category_entity" DROP COLUMN "user_id"`);
        await queryRunner.query(`ALTER TABLE "entry_entity" RENAME COLUMN "category_id" TO "categoryId"`);
